    ...
    <main className="flex-1 bg-[#121212] relative overflow-hidden flex items-center justify-center p-8">
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 w-[640px] max-w-[90%] bg-[#1E1E1E] rounded-2xl shadow-2xl border border-[#2D2D2D] p-1 z-30">
        <div className="flex items-center px-4 py-2 border-b border-[#2D2D2D] mb-1">
          <button type="button" className="text-xs font-semibold mr-6 text-[#EDEDED]">Past Chats</button>
          <button type="button" className="text-xs font-semibold mr-auto text-[#EDEDED]">New Chat</button>
          <button type="button" className="text-xs font-semibold text-[#A1A1A1] flex items-center hover:text-[#EDEDED]">
        ...
        <div className="flex items-center justify-between px-3 pb-2 pt-1">
          <div className="flex items-center space-x-3">
            <button type="button" className="flex items-center space-x-1.5 px-2 py-1 hover:bg-[#2D2D2D] rounded-md transition-colors text-[#A1A1A1] hover:text-[#EDEDED]">
              <ImageIcon size={16} />
              <span className="text-xs font-semibold">Auto</span>
            </button>
            <button type="button" className="p-1 hover:bg-[#2D2D2D] rounded-md text-[#A1A1A1]">
              <Plus size={16} />
            </button>
