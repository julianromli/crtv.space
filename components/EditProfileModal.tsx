    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-[#1E1E1E] w-full max-w-xl rounded-2xl shadow-2xl border border-[#2D2D2D] overflow-hidden">
        <div className="flex items-center justify-between p-5 border-b border-[#2D2D2D]">
          ...
          <button type="button" onClick={onClose} className="text-[#9CA3AF] hover:text-[#F3F4F6] transition-colors">
            <X size={20} />
          </button>
        </div>
        <div className="p-6 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
            <label htmlFor="profile-name" className="sm:w-1/3 text-sm font-semibold text-[#9CA3AF]">Name</label>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
            <label htmlFor="profile-username" className="sm:w-1/3 text-sm font-semibold text-[#9CA3AF]">Username</label>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-6">
            <label htmlFor="profile-bio" className="sm:w-1/3 text-sm font-semibold text-[#9CA3AF] pt-2">Bio</label>
            <div className="sm:w-2/3">
              <textarea 
                value={bio} 
                id="profile-bio"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
            <label htmlFor="profile-photo" className="sm:w-1/3 text-sm font-semibold text-[#9CA3AF]">Profile photo</label>
            <div className="sm:w-2/3 flex items-center gap-4">
              <Image src={avatar} alt="Avatar" width={48} height={48} className="w-12 h-12 rounded-full object-cover border border-[#2D2D2D]" />
              <button
                type="button"
        ...
        <div className="p-5 border-t border-[#2D2D2D] flex justify-end gap-3 bg-[#1A1A1A]">
          <button type="button" onClick={onClose} className="px-4 py-2 rounded-md text-sm font-semibold text-[#F3F4F6] hover:bg-[#2D2D2D] transition-colors">
            Cancel
          </button>
          <button
            type="button"
